...
class First{
	...
	"<html>\n"+
	   ...
	   "\n<body>\n"+
	      "<h1>Enter Book</h1>\n<br />\n"+
	      "<br/><form method =\"post\" action =\"http://undcemcs02.und.edu/~mark.arinaitwe/cgi-bin/513/2/books.cgi\" target=\"view\">"+
	    ...
	    String query = "SELECT distinct e.subject_name from books2 b, table(b.subjectList) e";
          ...
          //System.out.println("<br><tr>"); 
            while (rset.next())
            {
             sub=    rset.getString("subject_name");
